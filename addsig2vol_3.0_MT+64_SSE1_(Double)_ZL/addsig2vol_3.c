...
//#define __linux__
   ...
   #ifdef __linux__       ////Modified by ZL, the head file should be include at the begin of the code
...
//#ifdef addsig2vol_debug 
  ...
  //  #include <time.h>
  //  #include <unistd.h>                            //Modified by ZL, the head file should be include at the begin of the code
